      ...
      <div className="pt-50 pb-20 max-md:pt-36 w-full  flex flex-col items-center gap-4 ">
        ...
        <div className="addComment w-[70%] max-md:w-[90%] mt-10">
           ...
           <form className="w-full h-[50vh] flex flex-col gap-5 mt-5">
            <input type="text" placeholder="Name" className="w-[40vw] max-lg:w-[60vw] max-md:w-[85vw] outline-2 outline-zinc-200 p-2 rounded"/>
            <textarea className="w-[40vw] max-lg:w-[60vw] max-md:w-[85vw] h-64 outline-2 outline-zinc-200 p-2 rounded" placeholder="comment" />
            <button className="w-fit px-4 py-1 bg-[#4F4EE9] text-white rounded">Submit</button>
           </form>
        </div>
      </div>
